...
alias mongoprod="mongo 'mongodb+srv://production.crwfa.gcp.mongodb.net/affable' --username admin -p T1n5wbUj5gVw8fLR"
alias mongodev="mongo 'mongodb+srv://staging.crwfa.gcp.mongodb.net/affable' --username admin -p T1n5wbUj5gVw8fLR"
alias cassandraprod="ssh -i /home/rodo/keys/affable_cassandra.pem bitnami@10.148.0.46"
alias openvpnprod="openvpn3 session-start --config /home/rodo/Downloads/client.ovpn"
...
export PATH=$HOME/Downloads/WebStorm-211.7442.26/bin:$PATH
...
export PATH="$PATH:/snap/flutter/bin:/andriod-studio/andriod-studio/bin:/usr/lib/dart/bin"
# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/rodo/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/rodo/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/rodo/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/rodo/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
